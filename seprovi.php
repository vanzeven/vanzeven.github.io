...
$weather = json_decode(file_get_contents("http://api.openweathermap.org/data/2.5/weather?q=".$location."&appid=8628623ed9f91e45099c2eee2fb0845c"), TRUE)["weather"][0]["main"];
